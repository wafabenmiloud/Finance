        ...
        <section id="ventes_section1">
          <div className="ventes_head">
            <div className="ventes_buttons">
              ...
              <button
                onClick={() => toggleSection("confirme")}
                className={sections.confirme ? "ventes_buttonVisible" : ""}
              >
                Confirmé
              </button>
              <button
                onClick={() => toggleSection("refuse")}
                className={sections.refuse ? "ventes_buttonVisible" : ""}
              >
                Refusé
              </button>
              <button
                      ...
                      >
                        ...
                        >
                          <p className="achat_comm_p">
                            Vous n'avez créé encore aucune offre. <br />{" "}
                            <button
                            ...
                            >
                              Commencez par saisir une offre.
                            </button>
                          </p>{" "}
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <select
                            ...
                            className="search_text"
                          >
                            <option selected value="">Sélectionner une action</option>
                            <option value="">
